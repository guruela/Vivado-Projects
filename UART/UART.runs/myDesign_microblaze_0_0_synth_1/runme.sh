...
HD_PWD='D:/Xilinx/Projects/UART/UART.runs/myDesign_microblaze_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myDesign_microblaze_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myDesign_microblaze_0_0.tcl
