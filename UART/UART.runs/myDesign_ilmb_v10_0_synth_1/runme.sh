...
HD_PWD='D:/Xilinx/Projects/UART/UART.runs/myDesign_ilmb_v10_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myDesign_ilmb_v10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myDesign_ilmb_v10_0.tcl
