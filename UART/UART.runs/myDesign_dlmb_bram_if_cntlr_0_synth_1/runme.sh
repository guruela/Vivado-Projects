...
HD_PWD='D:/Xilinx/Projects/UART/UART.runs/myDesign_dlmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myDesign_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myDesign_dlmb_bram_if_cntlr_0.tcl
