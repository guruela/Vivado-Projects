...
HD_PWD='D:/Xilinx/Projects/UART/UART.runs/myDesign_mdm_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myDesign_mdm_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myDesign_mdm_1_0.tcl
