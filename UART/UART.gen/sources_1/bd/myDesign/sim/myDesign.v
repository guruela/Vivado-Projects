...
module m00_couplers_imp_1XUR3BC
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module m01_couplers_imp_5PFGBT
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module microblaze_0_local_memory_imp_17BXNBI
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > myDesign microblaze_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  myDesign_dlmb_bram_if_cntlr_0 dlmb_bram_if_cntlr
  ...
  myDesign_dlmb_v10_0 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  myDesign_ilmb_bram_if_cntlr_0 ilmb_bram_if_cntlr
...
(* CORE_GENERATION_INFO = "myDesign,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=myDesign,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=16,numReposBlks=11,numNonXlnxBlks=0,numHierBlks=5,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=2,da_board_cnt=4,da_mb_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "myDesign.hwdef" *) 
module myDesign
   (reset,
    rx_0,
    sys_clock,
  ...
  input rx_0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SYS_CLOCK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SYS_CLOCK, CLK_DOMAIN myDesign_sys_clock, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input sys_clock;
  output tx_0;
  ...
  myDesign_axi_interconnect_0_0 axi_interconnect_0
  ...
  myDesign_axi_uartlite_0_0 axi_uartlite_0
       (.rx(rx_0),
        ...
        .tx(tx_0));
  myDesign_clk_wiz_0_0 clk_wiz_0
       (.clk_in1(sys_clock),
        .clk_out1(microblaze_0_Clk),
        .locked(clk_wiz_0_locked),
        .reset(reset));
  myDesign_mdm_1_0 mdm_1
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > myDesign microblaze_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  myDesign_microblaze_0_0 microblaze_0
  ...
  microblaze_0_local_memory_imp_17BXNBI microblaze_0_local_memory
...
module myDesign_axi_interconnect_0_0
   (ACLK,
    ARESETN,
    M00_ACLK,
    M00_ARESETN,
  ...
  m00_couplers_imp_1XUR3BC m00_couplers
       (.M_ACLK(ACLK),
        .M_ARESETN(ARESETN),
        ...
        .M_AXI_bresp(M00_AXI_bresp[0]),
        .M_AXI_bvalid(M00_AXI_bvalid),
        .M_AXI_rdata(M00_AXI_rdata[0]),
        .M_AXI_rready(M00_AXI_rready),
        .M_AXI_rresp(M00_AXI_rresp[0]),
  ...
  m01_couplers_imp_5PFGBT m01_couplers
       (.M_ACLK(ACLK),
        .M_ARESETN(ARESETN),
  ...
  s00_couplers_imp_TU6YY s00_couplers
       (.M_ACLK(ACLK),
        .M_ARESETN(ARESETN),
  ...
  myDesign_axi_interconnect_0_imp_xbar_0 xbar
       (.aclk(ACLK),
        .aresetn(ARESETN),
